        ...
        <div class="row">
            <div class="breadcrumbs u-margin-top-9 u-margin-bottom-19">
                <div class="breadcrumbs--title">
                    <h5><a href="#" class="title">ویرایش شرکت</a></h5>
                    <img src="{{url('public/images/arrow_down.svg')}}" alt="" class="breadcrumbs--icon"/>

                </div>
            </div>
        </div>
        <form class="row" action="{{url('companys/update')}}" method="post">
            {{ csrf_field() }}
            ...
            <input type="hidden" hidden   name="id" value="{{$result->id}}">
                ...
                <div class="row u-margin-0">
                    <div class="master__form">
                                                ...
                                                <div class="m-form--group">
                                                    ...
                                                    <div class="m-form--group--bottom">
                                                        <div class="m-form--control--row">
                                                            <div class="container__forms">
                                                                <input type="text" name="address"  value="{{$result->address }}" maxlength="100"
                                                                       class="m-form--control m-form--control--input">
                                                            </div>
                                                            <span
                                            ...
                                            <div class="col-md-6 col-sm-12 u-margin-bottom-sm-16">
                                                <div class="m-form--group">
                                                    ...
                                                    <div class="m-form--group--bottom">
                                                        <div class="m-form--control--row">
                                                            <div class="container__forms">
                                                                <input type="text" name="address_state" maxlength="50"
                                                                       value="{{$result->address_state }}"
                                                                       class="m-form--control m-form--control--input">
                                                            </div>
                                                        </div>
                                                        <span
                                            ...
                                            <div class="col-md-6 col-sm-12 u-margin-bottom-sm-16">
                                                <div class="m-form--group">
                                                    ...
                                                    <div class="m-form--group--bottom">
                                                        <div class="m-form--control--row">
                                                            <div class="container__forms">
                                                                <input type="text" name="address_postal_code" maxlength="11"
                                                                       value="{{$result->address_postal_code }}"
                                                                       class="m-form--control m-form--control--input">
                                                            </div>
                                                        </div>
                                                        <span
                                            ...
                                            <div class="col-md-6 col-sm-12 u-margin-bottom-sm-16">
                                                <div class="m-form--group">
                                                    ...
                                                    <div class="m-form--group--bottom">
                                                        <div class="m-form--control--row">
                                                            <div class="container__forms">
                                                                <input type="text" name="address_country" maxlength="50"
                                                                       v-model="company.address_country"
                                                                       value="{{$result->address_country }}"
                        ...
                        <textarea type="text" cols="2" name="description" maxlength="200"
                                  class="m-form--control m-form--control--input"> {{$result->description}} </textarea>
                                                            </div>
                                                            <span
